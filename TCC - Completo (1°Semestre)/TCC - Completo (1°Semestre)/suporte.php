...
<body class="dark">
  ...
  <div class="main-content-wrapper">
    <!-- Conteúdo original de ajuda.html começa aqui -->
    <div class="ajuda-container">
      ...
      <!-- Seção: Selecione o tipo de problema -->
      ...
      <section class="faq-section">
        ...
        <div class="faq-list" id="faq-list">
          <!-- FAQs serão preenchidas via JavaScript -->
        </div>
      </section>
    </div>
    <!-- Conteúdo original de ajuda.html termina aqui -->
  </div>
